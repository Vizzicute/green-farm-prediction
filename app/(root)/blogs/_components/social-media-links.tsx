...
const SocialMediaLinks = () => {
    const trpc = useTRPC()
    const { data: settings } = useQuery(trpc.getSettingsByCategory.queryOptions({ category: "social" }));
    const socialSettings: SocialLinksSettings = settings ? JSON.parse(settings.value) : {};
